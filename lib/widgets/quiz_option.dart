...
class QuizOption extends StatelessWidget {
  ...
  final bool isValidateClicked;
  final bool isCorrect;

  QuizOption(this.optionText, this.action, this.isClicked,this.isValidateClicked,this.isCorrect);
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: isClicked ? (isValidateClicked?(isCorrect?Colors.green:Colors.red): Colors.blue.shade100 ): Colors.white,
