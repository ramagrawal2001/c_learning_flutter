...
class IndexTheoryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final theory = Provider.of<TheoryContent>(context,listen: false).findById(indexId);
    return Scaffold(
      appBar: AppBar(
        title: Text(theory.subIndex[index],style: TextStyle(overflow: TextOverflow.visible),),
        backgroundColor: Color(0xff645CAA),
        leadingWidth: 25,
      ),
      body: theory.theoryContent[index],
    );
  }
}
